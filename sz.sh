...
TIMES="10"
CHATID="6134500139"
KEY="6822328013:AAEl-M0js9YkhICvls-66qf2VxHLFtlobAQ"
...
clear
rm -f /usr/bin/user
username=$(curl https://raw.githubusercontent.com/sanzVPN/vip/main/REGIST | grep $MYIP | awk '{print $2}')
echo "$username" >/usr/bin/user
expx=$(curl https://raw.githubusercontent.com/sanzVPN/vip/main/REGIST | grep $MYIP | awk '{print $3}')
echo "$expx" >/usr/bin/e
...
Exp1=$(curl https://raw.githubusercontent.com/sanzVPN/vip/main/REGIST | grep $MYIP | awk '{print $4}')
if [[ $today < $Exp1 ]]; then
sts="${Info}"
else
sts="${Error}"
...
clear
# REPO    
    REPO="https://raw.githubusercontent.com/sanzVPN/vip/main/"
...
clear
restart_system() {
USRSC=$(wget -qO- https://raw.githubusercontent.com/sanzVPN/vip/main/REGIST | grep $ipsaya | awk '{print $2}')
EXPSC=$(wget -qO- https://raw.githubusercontent.com/sanzVPN/vip/main/REGIST | grep $ipsaya | awk '{print $3}')
...
wget raw.githubusercontent.com/sanzVPN/vip/main/files/limit.sh && chmod +x limit.sh && ./limit.sh
cd
